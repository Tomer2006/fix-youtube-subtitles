...
- **Text scale (%)** — subtitle size as a percentage of the active player. `100`
  matches the normal player-relative size; lower or higher values scale with
  regular view, theater mode, fullscreen, Shorts, and embeds.
